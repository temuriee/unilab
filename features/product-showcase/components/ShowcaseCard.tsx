      ...
      <div className="relative w-full aspect-[4/3] bg-gray-100">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 flex items-end justify-between gap-2 bg-[#262626]">
          ...
          <div className="flex items-center gap-2 shrink-0 ">
            <button className="bg-[#262626] border border-white text-white text-xs font-semibold px-3 py-1.5 rounded-md hover:bg-orange-500 hover:text-white transition-colors duration-200 whitespace-nowrap flex gap-2">
