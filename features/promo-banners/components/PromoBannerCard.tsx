...
export function PromoBannerCard({ banner }: PromoBannerCardProps) {
  return (
    <div className="flex flex-1 overflow-hidden max-w-[395.5px] min-w-[395.5px] max-h-[470px] min-h-[470px] lg:max-w-[620px] lg:max-h-[383px] lg:min-w-[620px] lg:min-h-[383px] ">
      {/* Text side */}
      <div
        className="flex flex-col justify-center gap-4 py-8 px-5 max-w-[197.75px] min-w-[197.75px]  max-h-[467px] min-h-[467px] lg:max-w-[310px] lg:max-h-[383px] lg:min-h-[383px] lg:min-w-[310px] "
        style={{ backgroundColor: banner.bgColor }}
      >
        <h2 className="text-white font-extrabold text-4xl leading-tight">
          {banner.title}
        </h2>
        <p className="text-white/90 text-[28px] ">{banner.description}</p>
        <Link
